...
#img_fn = 'Data/Classification/Classification/51/C518 (87).jpg'

#img_fn = 'Data/Unlabeled/normal/C4_Frame (2).jpg'
...
segmentation_images = glob('Data/Unlabeled/lesion_c8/*.jpg')

segmentation_images = sorted_nicely(segmentation_images)

print(len(segmentation_images))

prefix = 'Data/Unlabeled/lesion_c8_seg_vid/'

for i in range(len(segmentation_images)):

	img_fn = segmentation_images[i]
	...
	plt.savefig(prefix + 'seg_scores_' + str(i) + '.png', bbox_inches='tight')
